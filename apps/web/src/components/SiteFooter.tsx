...
export function SiteFooter() {
  ...
  return (
    <footer className="border-t border-border bg-sand/40">
      <div className="mx-auto max-w-5xl px-6 py-10 text-small">
        <div className="flex flex-wrap gap-x-10 gap-y-8">
          ...
          <nav aria-label="Bölümler" className="min-w-[10rem]">
            <p className="text-label text-text-muted uppercase">Bölümler</p>
            <ul className="mt-3 space-y-2">
              <li>
                <Link href="/tr/atlar" className="hover:text-brass-text">
                  Satılık atlar
                </Link>
              </li>
              <li>
                <Link href="/tr/hizmetler" className="hover:text-brass-text">
                  Hizmetler
                </Link>
              </li>
              <li>
                <Link href="/tr/isler" className="hover:text-brass-text">
                  İşler
                </Link>
              </li>
              <li>
                <Link href="/tr/fiyatlandirma" className="hover:text-brass-text">
                  Fiyatlandırma
                </Link>
              </li>
            </ul>
          ...
          <nav aria-label="Yasal" className="min-w-[12rem]">
            <p className="text-label text-text-muted uppercase">Yasal</p>
            <ul className="mt-3 space-y-2">
              {documents.map((document) => (
                <li key={document.path}>
                  <Link href={`/tr/${document.path}`} className="hover:text-brass-text">
                    {document.title}
                  </Link>
                </li>
              ))}
        ...
        <p className="text-text-muted mt-10 border-t border-border pt-6">
